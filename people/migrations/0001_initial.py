    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("homeland_zipcode", models.CharField(blank=True, max_length=10)),
                ("homeland_town", models.CharField(blank=True, max_length=50)),
                (
                    "homeland_country",
                    django_countries.fields.CountryField(
                        blank=True, default="", max_length=2, null=True
                ...
                ("residence_zipcode", models.CharField(blank=True, max_length=10)),
                ("residence_town", models.CharField(blank=True, max_length=50)),
                (
                    "residence_country",
                    django_countries.fields.CountryField(
                ...
                ("homeland_phone", models.CharField(blank=True, max_length=50)),
                ("residence_phone", models.CharField(blank=True, max_length=50)),
                (
                ...
                (
                    "mother_tongue",
                    languages.fields.LanguageField(
                        blank=True,
                        choices=[
                            ("aa", "Afar"),
                            ("ab", "Abkhazian"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("websites", models.ManyToManyField(blank=True, to="common.website")),
            ],
            options={
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(
                    ...
                    models.Q(
                        models.Q(("user__isnull", True), _negated=True),
                        models.Q(("nickname__exact", ""), _negated=True),
                    ),
                    models.Q(
                        models.Q(("user__isnull", True), _negated=True),
