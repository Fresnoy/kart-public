...
class UserResource(ModelResource):
    class Meta:
        ...
        filtering = {"first_name": ALL, "last_name": ALL}
...
class ArtistResource(ModelResource):
    class Meta:
        ...
        filtering = {"user": ALL_WITH_RELATIONS, "resource_uri": ALL}
    ...
    collectives = fields.ToManyField(
        "people.api.ArtistResource", "collectives", full=False
    )
    members = fields.ToManyField("people.api.ArtistResource", "members", full=True)
    artworks = fields.ToManyField(
        "production.api.ArtworkResource",
        "artworks",
        full=False,
        null=True,
        use_in=["detail"],
