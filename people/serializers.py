...
class ArtistSerializer(serializers.HyperlinkedModelSerializer):
    ...
    members = serializers.HyperlinkedIdentityField(
        view_name="artist-detail", many=True, required=False
    )
    ...
    def get_visiting_student(self, obj):
        try:
            ...
            return VisitingStudentSerializer(
                obj.visiting_student, context=self.context
            ).data
        except Exception:
            return None
...
class StaffSerializer(serializers.ModelSerializer):
    ...
    user = serializers.HyperlinkedRelatedField(view_name="user-detail", read_only=True)
    production_task = ProductionTaskSerializer(
        source="productionstafftask_set", many=True, read_only=True
    )
