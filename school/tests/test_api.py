...
@pytest.mark.django_db
class TestStudentRessource(
    HaystackSearchModelRessourceMixin, HelpTestForReadOnlyModelRessource
):
    ...
    def test_user__last_name__istartswith_search(
        self, client, user_role, auth_method, request
    ):
