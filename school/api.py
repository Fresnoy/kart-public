...
class StudentResource(ArtistResource):
    ...
    def build_filters(self, filters=None, ignore_bad_filters=False):
        ...
        return super(StudentResource, self).build_filters(
            filters, ignore_bad_filters=True
        )

    # override user__last_name__istartswith query
    def apply_filters(self, request, applicable_filters):
        base_object_list = super(StudentResource, self).apply_filters(
    ...
    def get_search(self, request, **kwargs):
        ...
        sqs = (
            ...
            .models(Student)
            .load_all()
            .autocomplete(content_auto=request.GET.get("q", ""))
        )
